...
class BranchFragment : ScopedFragment(), KodeinAware {
    ...
    override fun onCreateView(
        ...
        if (!::mBinding.isInitialized) {
            mBinding = BranchFragmentBinding.inflate(inflater, container, false).apply {
