...
class EmploymentDetailsFragment : ScopedFragment(), KodeinAware {
    override val kodein by lazy { (activity?.applicationContext as KodeinAware).kodein }
    lateinit var mBinding: EmploymentDetailsFragmentBinding
    ...
    override fun onCreateView(
        ...
        if (!::mBinding.isInitialized) {
            mBinding = EmploymentDetailsFragmentBinding.inflate(inflater, container, false).apply {
